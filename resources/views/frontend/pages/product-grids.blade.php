...
@section('title','V-SHOP || TRANG SẢN PHẨM')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html">Hệ thống cửa hàng</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">${{number_format($product->price,0)}}<a> VNĐ</a></del>   ${{number_format($org,0)}}<a> VNĐ</a>  </p>
                                    ...
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="price" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price') selected @endif>Giá thành</option>
                                                <option value="category" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category') selected @endif>Loại</option>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                @endphp
                                                <span>${{number_format($after_discount,0)}}<a> VNĐ</a></span>
                                                <del style="padding-left:4%;">${{number_format($product->price,0)}}<a> VNĐ</a></del>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        <div class="quickview-content">
                                            ...
                                            @php
                                                $after_discount=($product->price-($product->price*$product->discount)/100);
                                            @endphp
                                            <h3><small><del class="text-muted">${{number_format($product->price,0)}}<a> VNĐ</a></del></small>    ${{number_format($after_discount,0)}}<a> VNĐ</a>  </h3>
...
@push('scripts')
    ...
    <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=657d2079088a0f0019878deb&product=inline-follow-buttons' async='async'></script>
@endpush
