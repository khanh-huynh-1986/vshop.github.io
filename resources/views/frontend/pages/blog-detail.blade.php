...
@section('title','E-TECH || Trang Chi Tiết Blog')
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Để lại một bình luận</h2>
                                        <!-- Comment Form -->
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget search">
                            <form class="form" method="GET" action="{{route('blog.search')}}">
                                <input type="text" placeholder="Tìm ở đây..." name="search">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Đăng ký & nhận tin tức <br> mới nhất.</h4>
                                <form action="{{route('subscribe')}}" method="POST">
                                    @csrf
                                    <div class="form-inner">
                                    <h7><input type="email" name="email" placeholder="Enter your email"></h7>
