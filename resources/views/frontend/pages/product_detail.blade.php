...
@endsection
@section('title','V-SHOP || CHI TIẾT SẢN PHẨM')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">${{number_format($after_discount,0)}}<a> VNĐ</a></span><s>${{number_format($product_detail->price,0)}}<a> VNĐ</a></s> </p>
										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">Sự miêu tả</a></li>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Địa chỉ email của chúng tôi sẽ không được công bố. Các trường bắt buộc được đánh dấu</p>
																	</div>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Based on {{$product_detail->getReview->count()}} Bình luận</span>
																	</div>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">${{number_format($data->price,0)}}<a> VNĐ</a></span>
