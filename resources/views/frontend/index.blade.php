...
@section('title','V-SHOP || TRANG CHỦ')
                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                @if($product->stock<=0)
                                                    <span class="out-of-stock">Bán ra</span>
                    ...
                    @foreach($product_lists as $product)
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
                                <div class="product-price">
                                    <span class="old">{{number_format($product->price,0)}}<a> VNĐ</a></span>
                                    @php
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    @endphp
                                    <span>{{number_format($after_discount,0)}}<a> VNĐ</a></span>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">{{number_format($product->price,0)}}<a> VNĐ</a></p>
                                    </div>
                                </div>
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-service">
                    ...
                    <p>Trong vòng 30 ngày đổi trả</p>
                </div>
                <!-- End Single Service -->
            </div>
            <div class="col-lg-3 col-md-6 col-12">
...
@push('styles')
<script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=657d2079088a0f0019878deb&product=inline-follow-buttons&source=platform" async="async"></script>
