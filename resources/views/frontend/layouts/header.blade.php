                                        ...
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                            @foreach(Helper::getAllProductFromWishlist() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <p class="quantity">{{$data->quantity}} x - <span class="amount">${{number_format($data->price,0)}}<a> VNĐ</a></span></p>
                                                    </li>
                                            @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Tổng</span>
                                            <span class="total-amount">${{number_format(Helper::totalWishlistPrice(),0)}}<a> VNĐ</a></span>
                                        </div>
                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Tổng</span>
                                            <span class="total-amount">${{number_format(Helper::totalCartPrice(),0)}}<a> VNĐ</a></span>
                                        </div>
